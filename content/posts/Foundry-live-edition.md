...
Well, today, during my **first online session** (after a time zone mix-up, oops), I received the most wholesome comment. And don’t I feel like I’m on cloud nine? Okay, I know you didn’t ask, but here’s the feedback I got:
...
Before we dive into the session itself, let’s address the elephant in the room: **time zones.**
...
So, next time your brain fails you because of time zones—**don’t stress**. It happens! And sometimes, the only solution is to **not beat yourself up over it.**
...
Since I’ve now become the unofficial **Azure AI** **Foundry spokesperson**, let’s shift gears a bit and talk about **Prompty**—what it is and why you should care.

I see **Prompty** as a **bridge beyond simple API calls** when working with models—allowing you to create a **custom model playground** directly in your **Visual Studio Code** environment.
