...
This Learn Live session provided a hands-on exploration of creating sophisticated AI agents that can use custom tools and integrate with external services to solve complex business problems.

## Learning objectives
By the end of this module, you'll be able to:
Describe the benefits of using custom tools with your agent.
Explore the different options for custom tools.
Build an agent that integrates custom tools using the Azure AI Agent Service.

Integrate custom tools into your agent - https://aka.ms/LLAA4/y
